sap.ui.jsview("com.cg.gtm.view.Drop3_MOB01.MOB01TrainDetailEdit", {

	/** Specifies the Controller belonging to this View.
	 * In the case that it is not implemented, or that "null" is returned, this View does not have a Controller.
	 * @memberOf drop3mockups.MOB01.MOB01TrainDetailEdit
	 */
	getControllerName: function () {
		return "com.cg.gtm.view.Drop3_MOB01.MOB01TrainDetailEdit";
	},
	
	onBeforeShow: function () {
		sap.ui.getCore().byId("MOB01TrainEditIconTabBar").setSelectedKey("firstTab");
	},
	...
	createContent: function (oController) {
		...
		function resolveOnSuccess(entry){ 
		   ...
		   // window.resolveLocalFileSystemURI("file:///storage//sdcard/MOB01IMF", onResolveSuccess2, fail2);
		    ...
		    //new file name
		    newFileName = "MOB01IM_" + n + ".jpg";
		    var myFolderApp = "MOB01IMF";
		...
		function successMove(entry) {
			...
			// alert("done");
			 var notiImage = new Array();
			 var items = window.localStorage.getItem('MOB01IM_');
			 if (items === undefined || items === null || items.length === 0)
			 {
				...
				var imageModelString = 	JSON.stringify(notiImage);
					 window.localStorage.setItem("MOB01IM_", imageModelString);
					// alert("now set  ");
					 var items2 = window.localStorage.getItem('MOB01IM_');
					// alert(items2);
			...
			// window.resolveLocalFileSystemURI("file:///storage//sdcard/MOB01IMF", onResolveSuccess, fail);
				 window.resolveLocalFileSystemURI("file:///storage//emulated/0/MOB01IMF", onResolveSuccess, fail);
		};
			  ...
			  var len = oImageArrReceived.length;
			   ...
			   /* containerImage3.setVisible(false);
			    ...
			    if (len >= 3)
				{
				 ...
				 console.log(3);
				 sap.ui.getCore().byId("image1MOB01").setSrc("file:///storage//emulated/0/MOB01IMF/"+oImageArrReceived[len-1]);
				 sap.ui.getCore().byId("image2MOB01").setSrc("file:///storage//emulated/0/MOB01IMF/"+oImageArrReceived[len-2]);
				 sap.ui.getCore().byId("image3MOB01").setSrc("file:///storage//emulated/0/MOB01IMF/"+oImageArrReceived[len-3]);
				...
				new sap.m.IconTabBar({
					...
					items: [
								...
								new sap.ui.layout.form.SimpleForm({
									...
									content: [
										...
										new sap.m.Input({
											...
											valueHelpOnly : true ,
											id :  "MOB01TEFF" , 
											valueHelpRequest: [oController.handleValueHelpEFF, oController]
										}),
										new sap.m.Label({
										...
										new sap.m.Input({
											...
											valueHelpOnly : true ,
											id :  "MOB01TPRI",
											 valueHelpRequest: [oController.handleValueHelpPRIT, oController]
										}),
										...
										new sap.m.Input({
											...
											showValueHelp: true,
											valueHelpOnly : true ,
											valueHelpRequest: [oController.handleValueHelpHeadCode, oController]
											//handleValueHelpHeadCode
						...
						new sap.m.IconTabFilter({
							...
							content: [
								new sap.m.List({
									id: "MOB01TrainDetailEditComponentList",
...
//												}),
//												new sap.m.Input({
//													id: "MOB01TrainEditQuantityInput",
//													type: "Number"
//												}),
//												new sap.m.Text({
//													text: "{materials>Uom}"
	...
	headerToolbar: new sap.m.Toolbar({
		content: [
		          ...
		          new sap.m.Button({
		        	  ...
		        	  press : function()
		        	  {
		        		  //oController.takePhoto();
		        		  //cmraDialog.open();
		        		  
		        		  //DMS
		        		  g_DeleteImageListId = "Mob01AddedImageList";
