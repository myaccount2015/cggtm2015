sap.ui.jsview("com.cg.gtm.view.Mob18WBS_Bearingcase", {

	/** Specifies the Controller belonging to this View. 
	* In the case that it is not implemented, or that "null" is returned, this View does not have a Controller.
	* @memberOf view.Mob18WBS_Bearingcase
	*/ 
	getControllerName : function() {
		return "com.cg.gtm.view.Mob18WBS_Bearingcase";
	},
	...
	*/ 
	createContent : function(oController) {
		...
		var inputSerial = new sap.m.Input("inputSerial_WBS",{
		...
		var inputUoM = new sap.m.Input("inputUoM_WBS",{
		     // type: sap.m.InputType.Text,
			 type: sap.m.InputType.Text,
		...
		var inputBatch = new sap.m.Input("inputbatch_WBS",{
		     // type: sap.m.InputType.Text,
			 type: sap.m.InputType.Text,
		...
		var inputQuantity = new sap.m.Input("inputQty_WBS",{
		     // type: sap.m.InputType.Text,
			 type: sap.m.InputType.Text,
		...
		var inputLocation = new sap.m.Input("inputLoc_WBS",{
		     // type: sap.m.InputType.Text,
			 type: sap.m.InputType.Text,
		...
		var inputLocation_no = new sap.m.Input("inputLocno_WBS",{
		     // type: sap.m.InputType.Text,
			 type: sap.m.InputType.Text,
		...
		var selectReason = new sap.m.Select("selectReason_WBS", {
		      items: {
		        path: "/MOB18Reason",
		...
		var btnBack = new sap.m.Button({
			...
			//	btnShow.setVisible(false);
				hideidMob18first_WBS();
				hideidMob18second_WBS();
