...
sap.ui.controller("com.cg.gtm.view.Drop3_MOB09.MOB09InstallDetail", {
	...
	handleInstallButtonPress: function () {
		
		if ( undefined == 	window.localStorage.getItem(g_ordnum + "_" + g_actnum+"_"+"INSTALL"))
		{
		window.localStorage.setItem(g_ordnum + "_" + g_actnum+"_"+"INSTALL", 
				sap.ui.getCore().byId("MOB09InstallPositionInput").getValue());
		}
	
	else
		{
	window.localStorage.removeItem(g_ordnum + "_" + g_actnum+"_"+"INSTALL");
	window.localStorage.setItem(g_ordnum + "_" + g_actnum+"_"+"INSTALL", 
			sap.ui.getCore().byId("MOB09InstallPositionInput").getValue()); 
		}
		
		drop3TRQ(g_ordnum + "_" + g_actnum, "INSTALL");
		writeToFileMOB09install(g_ordnum , g_actnum);
		sap.ui.getCore().byId("myApp").back();
	}
	
});

function writeToFileMOB09install(ordnum , actnum)
{
