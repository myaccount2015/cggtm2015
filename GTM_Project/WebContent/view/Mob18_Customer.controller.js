sap.ui.controller("com.cg.gtm.view.Mob18_Customer", {
...
//
//	}
	onCommonCustomerSel_mob18 : function(event){
	/*	g_SelectedCust18 = event.mParameters.listItems[0].mProperties; //Selected Plant from Common Plant Search
		...
		if(globalCustomerSearchFrom=="MOB18_scrap") {
			...
			inputcust_wbs.setValue(selectedCustomer);
				...
				var inputcust_wbs = sap.ui.getCore().byId("inputcustomer_cost");
				inputcust_wbs.setValue(selectedCustomer);
...
function customerSearchHelpCommon_mob18(acustList) {
	...
	var modelBind = sap.ui.getCore().byId("idcustomerlistmob18");
...
function getCustList_mob18()
{
	...
	defectDataModel.read(readRequestURL, null, null, false,   
          ...
          if(result.length > 0){
			...
			custSear = customerSearchHelpCommon_mob18(custSear);
