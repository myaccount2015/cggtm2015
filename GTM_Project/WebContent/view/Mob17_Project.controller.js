sap.ui.controller("com.cg.gtm.view.Mob17_Project", {
...
//
//	}
	onCommonProjectSel_mob17 : function(event){
		/*	g_SelectedCust18 = event.mParameters.listItems[0].mProperties; //Selected Plant from Common Plant Search
			...
			g_SelectedProj17 = event.mParameters.listItems[0].mProperties; //Selected Plant from Common Plant Search
			//g_Mob18SelectedPlant = event.mParameters.listItems[0].mProperties;
			//g_scrapSelectedPlant = event.mParameters.listItems[0].mProperties;
				...
				var inputPlant = sap.ui.getCore().byId("inputproject_mob17");
	...
	function projectSearchHelpCommon_mob17(acustList) {
		...
		var modelBind = sap.ui.getCore().byId("idprojectlistmob17");
	...
	function getProjList_mob17()
	{
		...
		defectDataModel.read(readRequestURL, null, null, false,   
	          ...
	          if(result.length > 0){
				...
				custSear = projectSearchHelpCommon_mob17(custSear);
