...
sap.ui.jsfragment("com.cg.gtm.view.DROP3_MOB37.MOB37ComponentAndToolDialog", {

	/** Is initially called once after the Controller has been instantiated. It is the place where the UI is constructed.
	 * Since the Controller is given to this method, its event handlers can be attached right away.
	 * @memberOf drop3mockups.MOB37.MOB37ComponentAndToolDialog
	 */
		...
		return new sap.m.Dialog({
						    		...
						    		if (oAction === sap.m.MessageBox.Action.YES) {
										...
										*/
											...
											var modeldata = model.oData.results;
												...
												for ( var i = 0 ; i < modeldata.length ; i ++)
													{if (modeldata[i].Materialno ==  numberInput_Mob37.getValue())
														{
										...
										*/var model = sap.ui.getCore().byId("MOB37ComponentList").getModel();
										...
										var modeldata = model.oData.results;
											...
											for ( var i = 0 ; i < modeldata.length ; i ++)
												{if (modeldata[i].Equipmentno ==  numberInput_Mob37.getValue())
													{
													modeldata.splice(i, 1);
			...
			endButton: new sap.m.Button({
				...
				press: function () {
					...
					if (numberInput_Mob37.getValueState() === "None") {
						numberInput_Mob37.setValueState("Error");
					}
					if (quantityInput.getValueState() === "None") {
						quantityInput.setValueState("Error");
					}
					if (numberInput_Mob37.getValueState() !== "Error" && quantityInput.getValueState() !== "Error") {
						var dialog = sap.ui.getCore().byId("MOB37ComponentAndToolDialog");
						var dialogMode = dialog.getTitle();
						var numberInput_Mob37 = sap.ui.getCore().byId("MOB37ComponentAndToolDialogNumberInput");
						var quantityInput = sap.ui.getCore().byId("MOB37ComponentAndToolDialogQuantityInput");
						...
						if (dialogMode === "Add Component") {
							var data = {
									PlantName: "North Pole Depot",
								      ManufacturerName: "",
								      Plant: "GWNP",
								      Materialno: numberInput_Mob37.getValue(),
								      Uom: "EA",
								      ...
								      Equipmentno : numberInput_Mob37.getValue(),
								     Available: "100"
							};
...
//				quantityInput.unbindProperty("description", false);
				...
				numberInput_Mob37.setValue("").setValueState("None");
			...
			beforeOpen: function() {
			  ...
			  /*//asym
				...
				//asym
*/				
			//	sap.ui.getCore().byId("MOB03ComponentAndToolDialogSerialInput").setValue(oSelectedItem);
