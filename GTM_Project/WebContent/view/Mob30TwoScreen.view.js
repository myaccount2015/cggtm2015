sap.ui.jsview("com.cg.gtm.view.Mob30TwoScreen", {
	...
	*/ 
	getControllerName : function() {
		return "com.cg.gtm.view.Mob30TwoScreen";
	},
	...
	*/ 
	createContent : function(oController) {
		var detailpage = sap.ui.view({id:"idMOB30Detail", viewName:"com.cg.gtm.view.Mob30DetailMaterial", type:sap.ui.core.mvc.ViewType.JS});
		var detailMatpage = sap.ui.view({id:"idMOB30MatDetail", viewName:"com.cg.gtm.view.Mob30MatDetail", type:sap.ui.core.mvc.ViewType.JS});
		...
		var oLayout1 = new sap.ui.layout.Splitter({
			contentAreas : [oCell,oCell1]
		});
		...
		//Pop win
		var txtBoxManualEntryLog = new sap.m.Input({id : "Mob30-thrdScr-txtBoxManualEntryLog1",
			maxLength : 7,
